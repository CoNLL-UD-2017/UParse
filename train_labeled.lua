...
function LabeledTrainer:createTrainData(indDtaPaths, outDataPath, language, uDVocab)
  local uDrel = uDVocab .. '/ud_rel.vocab'
  self.rel_vocab = DepPosDataIter.createDepRelVocab(indDtaPaths.train, uDrel)
...
function LabeledTrainer:trainLabeledClassifier(opts)
  ...
  self.rel_vocab = DepPosDataIter.createDepRelVocab(opts.inTrain, uDrel)
